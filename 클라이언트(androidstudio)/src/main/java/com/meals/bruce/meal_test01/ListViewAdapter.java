...
//         화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        ImageView iconImageView1 = (ImageView) convertView.findViewById(R.id.imageView1);
        ImageView iconImageView2 = (ImageView) convertView.findViewById(R.id.imageView2);
        TextView apprTextView = (TextView) convertView.findViewById(R.id.textView);
        ...
        apprTextView.setText(listViewItem.getAppr());
    ...
    public void addItem(Drawable icon1, Drawable icon2, String appr) {
